    ...
    const modalClick=()=>{
        ...
        return(
            <div className="modalContainer">
                ...
                <div>
                    {props.panier.map((article)=><PanierItems key={article.id} article={article} supprimerAllArticle={props.supprimerAllArticle} supprimerUnArticle={props.supprimerUnArticle}></PanierItems>)}
                </div>
