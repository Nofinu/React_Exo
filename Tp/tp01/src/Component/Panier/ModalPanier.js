    ...
    const modalClick=()=>{
        ...
        return(
            <div className="modalContainer">
                ...
                <div>
                    {props.panier.map((article,index)=><PanierItems key={index} article={article} supprimerAllArticle={props.supprimerAllArticle} supprimerUnArticle={props.supprimerUnArticle}></PanierItems>)}
                </div>
